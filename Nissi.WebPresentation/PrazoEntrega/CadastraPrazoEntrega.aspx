<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="CadastraPrazoEntrega.aspx.cs" Inherits="Nissi.WebPresentation.PrazoEntrega.CadastraPrazoEntrega" %>
...
<table style="margin-left: auto; width: 95%; margin-right: auto;">
    <tr>
        ...
        <td class="titulo">Cadastro de Prazo de Entrega</td>
    </tr>
</table>
<br />
...
<br />
<ajaxToolkit:ModalPopupExtender ID="mpeIncluirPrazoEntrega" runat="server" PopupControlID="pnlIncluirPrazoEntrega"
    TargetControlID="hdfTargetIncluirBitola" BehaviorID="mpeIncluirPrazoEntregaID" BackgroundCssClass="modalBackground"
    DropShadow="true" />    
<asp:Panel ID="pnlIncluirPrazoEntrega" DefaultButton="btnSalvar" runat="server">
        ...
        <ContentTemplate>
            <div style="text-align: center;width:600px; height:auto; padding: 5px 5px 5px 5px; background-color: #ffffff;">
                ...
                <table width="100%" align="center" class="fundoTabela" >
                    <tr> 
                        <td>
                            <table cellpadding="3" cellspacing="0" class="fundoTabela" style="text-align:left">
                                ...
                                <tr>
                                    <td style="padding-left:20px; width: 209px;">Prazo de Entrega:</td>
                                    <td style="padding-left:20px">Dias</td>
                                </tr>
                                <tr>
                                    <td style="width: 209px">
                                        <asp:TextBox ID="txtDescricao" runat="server" CssClass="formNovo" 
                                            MaxLength="50" TabIndex="1" Width="174px"></asp:TextBox>
                                       <asp:RequiredFieldValidator Text="*" ErrorMessage="Favor informar o Prazo de Entrega." runat="server" ID="rfvBitola" ControlToValidate="txtDescricao" CssClass="asterisco" ValidationGroup="cadastro"></asp:RequiredFieldValidator>
                                    </td>
                                    <td><asp:TextBox runat="server" ID="txtIntervalo" onkeypress="OnlyNumbers();"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvBitola0" runat="server" 
                                            ControlToValidate="txtIntervalo" CssClass="asterisco" 
                                            ErrorMessage="Favor informar os Dias." Text="*" 
                    ...
                    <asp:HiddenField ID="hdfCodPrazoEntrega" runat="server" />
                </table>
            </div>
