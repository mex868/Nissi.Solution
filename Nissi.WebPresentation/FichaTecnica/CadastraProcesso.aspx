<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="CadastraProcesso.aspx.cs" Inherits="Nissi.WebPresentation.FichaTecnica.CadastraProcesso" %>
...
<table style="margin-left: auto; width: 95%; margin-right: auto;">
    <tr>
        ...
        <td class="titulo">Cadastro de Processo</td>
    </tr>
</table>
<br />
...
<br />
<ajaxToolkit:ModalPopupExtender ID="mpeIncluirProcesso" runat="server" PopupControlID="pnlIncluirProcesso"
    TargetControlID="hdfTargetIncluirProcesso" BehaviorID="mpeIncluirProcessoID" BackgroundCssClass="modalBackground"
    DropShadow="true" />    
<asp:Panel ID="pnlIncluirProcesso" runat="server">
        ...
        <ContentTemplate>
            <div style="text-align: center;width:900px; height:auto; padding: 5px 5px 5px 5px; background-color: #ffffff;">
                ...
                <table width="100%" align="center" class="fundoTabela" >
                    <tr> 
                        <td>
                            <table cellpadding="3" cellspacing="0" class="fundoTabela" style="text-align:left">
                                ...
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtProcesso" runat="server" CssClass="formNovo" 
                                            MaxLength="50" TabIndex="1" Width="300px"></asp:TextBox>
                                       <asp:RequiredFieldValidator Text="*" ErrorMessage="Favor informar o Processo." runat="server" ID="rfvProcesso" ControlToValidate="txtProcesso" CssClass="asterisco" ValidationGroup="cadastro"></asp:RequiredFieldValidator>
                                    </td>
                                    </tr>
                    ...
                    <asp:HiddenField ID="hdfCodProcesso" runat="server" />
                </table>
            </div>
...
<asp:HiddenField ID="hdfTargetIncluirProcesso" runat="server" />    
