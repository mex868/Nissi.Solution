<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="CadastraCaracteristica.aspx.cs" Inherits="Nissi.WebPresentation.FichaTecnica.CadastraCaracteristica" %>
...
<table style="margin-left: auto; width: 95%; margin-right: auto;">
    <tr>
        ...
        <td class="titulo">Cadastro de Característica</td>
    </tr>
</table>
<br />
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Ações">
                                     ...
                                     <asp:BoundField HeaderText="Código" >
                                         <headerstyle wrap="false" CssClass="headerGrid" Width="15%"></headerstyle>
                                         <itemstyle wrap="false" HorizontalAlign="Left"></itemstyle>
                                    </asp:BoundField>
                                    <asp:BoundField HeaderText="Descricao" >
                                        <HeaderStyle Wrap="false" CssClass="headerGrid" Width="45%"/>
...
<br />
<ajaxToolkit:ModalPopupExtender ID="mpeIncluirCaracteristica" runat="server" PopupControlID="pnlIncluirCaracteristica"
    TargetControlID="hdfTargetIncluirCaracteristica" BehaviorID="mpeIncluirCaracteristicaID" BackgroundCssClass="modalBackground"
    DropShadow="true" />    
<asp:Panel ID="pnlIncluirCaracteristica" DefaultButton="btnSalvar" runat="server">
        ...
        <ContentTemplate>
            <div style="text-align: center;width:900px; height:auto; padding: 5px 5px 5px 5px; background-color: #ffffff;">
                        ...
                        <td class="titulo">
                            <b>
                                <% if (hdfTipoAcao.Value == "Incluir") { %>
                                        ::Inclusão de Caracteristica
                                <% } %>
                                <% else { %>
                                        ::Alteração de Caracteristica
                                <% } %>
                            </b>
                        </td>
                    </tr>
                ...
                <table width="100%" align="center" class="fundoTabela" >
                    <tr> 
                        <td>
                            <table cellpadding="3" cellspacing="0" class="fundoTabela" style="text-align:left">
                                ...
                                <tr>
                                    <td style="padding-left:20px">Característica:</td>
                                    <td style="padding-left:20px">Tipo</td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtCaracteristica" runat="server" CssClass="formNovo" 
                                            MaxLength="50" TabIndex="1" Width="300px"></asp:TextBox>
                                       <asp:RequiredFieldValidator Text="*" ErrorMessage="Favor informar o Característica." runat="server" ID="rfvCaracteristica" ControlToValidate="txtCaracteristica" CssClass="asterisco" ValidationGroup="cadastro"></asp:RequiredFieldValidator>
                                    </td>
                                    <td>
                                        <asp:DropDownList ID="ddlTipo" runat="server"></asp:DropDownList>
                                       <asp:RequiredFieldValidator Text="*" ErrorMessage="Favor informar o Tipo." runat="server" ID="RequiredFieldValidator1" ControlToValidate="txtCaracteristica" CssClass="asterisco" ValidationGroup="cadastro"></asp:RequiredFieldValidator>
                                    </td>
                                    </tr>
                    ...
                    <asp:HiddenField ID="hdfCodCaracteristica" runat="server" />
                </table>
            </div>
...
<asp:HiddenField ID="hdfTargetIncluirCaracteristica" runat="server" />    
