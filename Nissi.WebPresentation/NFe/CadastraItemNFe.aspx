<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="CadastraItemNFe.aspx.cs" Inherits="CadastraItemNFe"
    Title="" %>
            ...
            <table cellpadding="3" cellspacing="0" class="fundoTabela" style="text-align: left">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <asp:TextBox ID="txtDescricao" runat="server" CssClass="DesligarTextBox" MaxLength="50"
                            TabIndex="1" Width="420px" Height="17px"></asp:TextBox>
                    </td>
                    <td>
                        <asp:DropDownList ID="ddlUnidade" runat="server" CssClass="formNovo" MaxLength="50"
                            TabIndex="2" Width="80px" Enabled="False">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="width: 126px; height: 23px;">
                        <asp:TextBox ID="txtQuantidade" onkeypress="OnlyMoney();" onBlur="CalculoTotais();"
                            runat="server" TabIndex="3" Width="98px"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Quatidade falta ser preenchido."
                            ControlToValidate="txtQuantidade" ValidationGroup="ValidaDados">*</asp:RequiredFieldValidator>
                    </td>
                    <td style="width: 133px; height: 23px;">
                        <asp:TextBox ID="txtValorItem" onkeypress="OnlyMoney();" onBlur="CalculoTotais();"
                            runat="server" TabIndex="4" Width="91px"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Preço de Venda falta ser preenchido."
                            ControlToValidate="txtValorItem" ValidationGroup="ValidaDados">*</asp:RequiredFieldValidator>
                    </td>
                    <td style="width: 161px; height: 23px;">
                        <asp:TextBox ID="txtDesconto" onBlur="CalculoTotais();" onkeypress="OnlyMoney();"
                            runat="server" TabIndex="5"></asp:TextBox>
                    </td>
                    <td colspan="2" style="height: 23px">
                        <asp:TextBox ID="txtTotalItem" onBlur="CalculoTotais();" runat="server" TabIndex="6"
                            ForeColor="Black" CssClass="DesligarTextBox"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="padding-left: 17px; width: 126px;">
                ...
                <tr>
                    <td style="width: 126px">
                        <asp:TextBox ID="txtICMS" onBlur="CalculoTotais();" runat="server" TabIndex="7" CausesValidation="True"
                            onkeypress="OnlyMoney();"></asp:TextBox>
                    </td>
                    <td style="width: 133px">
                        <asp:TextBox ID="txtBaseICMS" runat="server" TabIndex="8" ForeColor="Black" CssClass="DesligarTextBox"></asp:TextBox>
                    </td>
                    <td style="width: 161px">
                        <asp:TextBox ID="txtValorICMS" runat="server" TabIndex="9" ForeColor="Black" CssClass="DesligarTextBox"></asp:TextBox>
                    </td>
                    <td colspan="2">
                        <asp:TextBox ID="txtIPI" onBlur="CalculoTotais();" runat="server" TabIndex="11" onkeypress="OnlyMoney();"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td style="padding-left: 17px; width: 126px;">
                ...
                <tr>
                    <td style="width: 126px">
                        <asp:TextBox ID="txtValorIPI" runat="server" TabIndex="12" ForeColor="Black" ReadOnly="True"
                            CssClass="DesligarTextBox"></asp:TextBox>
                    </td>
                    <td style="width: 133px">
                        <asp:TextBox ID="txtSituacaoTributaria" runat="server" TabIndex="13" Width="94px"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Situação tributária falta ser preenchido."
                            ControlToValidate="txtSituacaoTributaria" ValidationGroup="ValidaDados">*</asp:RequiredFieldValidator>
                    </td>
                    <td style="width: 161px">
                        <asp:DropDownList ID="ddlClassificacaoFiscal" runat="server" CssClass="formNovo"
                            MaxLength="1" TabIndex="14" Width="124px" Enabled="False">
                        </asp:DropDownList>
                        &nbsp;
                    </td>
                    <td style="width: 123px">
                        <asp:TextBox ID="tbxCodPedido" TabIndex="15" CssClass="formNovo" runat="server" onkeypress="OnlyMoney()"></asp:TextBox>
                    </td>
                    <td style="width: 123px">
                        <asp:TextBox ID="tbxOP" TabIndex="16" CssClass="formNovo" Width="80px" runat="server" onkeypress="OnlyMoney()"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                <td style="padding-left: 17px">
                    <asp:CheckBox ID="ckbCalcSobIpi" runat="server" Text="Calcular ICMS Sob IPI" TabIndex="17" />
                </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="5">
                        <cc1:RDCGrid ID="ICMSGrid" runat="server" AutoGenerateColumns="False" BorderColor="Black"
                            ...
                            ShowOptionColumn="False" CssClass="alinhamento" OnRowDataBound="ICMSGrid_RowDataBound"
                            OnPageIndexChanging="ICMSGrid_PageIndexChanging" Width="100%">
                            <Columns>
    ...
    <asp:UpdatePanel ID="upBotoesCadastro" runat="server" UpdateMode="Always">
        <ContentTemplate>
            <table cellpadding="3" cellspacing="0" class="fundoTabela" style="text-align: left">
                <tr>
                    <td>
                        <asp:Button ID="btnIncluir" runat="server" CssClass="botao" OnClick="btnIncluir_Click"
                            Text="Incluir" Width="80px" ValidationGroup="ValidaDados" />
                    </td>
