<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="CadastraNorma.aspx.cs" Inherits="CadastraNorma" %>
...
<table style="margin-left: auto; width: 95%; margin-right: auto;">
    <tr>
        ...
        <td class="titulo">Cadastro de Norma</td>
    </tr>
</table>
<br />
                        ...
                        <div id="divListaResultado" runat="server" style="overflow: auto; display: block; text-align:center; height:400px;">
                            <cc1:RDCGrid 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="Norma" >
...
<br />
<ajaxToolkit:ModalPopupExtender ID="mpeIncluirNorma" runat="server" PopupControlID="pnlIncluirNorma"
    TargetControlID="hdfTargetIncluirNorma" BehaviorID="mpeIncluirNormaID" BackgroundCssClass="modalBackground"
    DropShadow="true" />    
<asp:Panel ID="pnlIncluirNorma" runat="server">
        ...
        <ContentTemplate>
            <div style="text-align: center;width:900px; height:auto; padding: 5px 5px 5px 5px; background-color: #ffffff;">
                ...
                <table width="100%" align="center" class="fundoTabela" >
                    <tr> 
                        <td>
                            <table cellpadding="3" cellspacing="0" class="fundoTabela" style="text-align:left">
                                ...
                                <tr>
                                    <td style="padding-left:20px">Norma:</td>
                                    <td style="padding-left:20px">Revisao:</td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtNorma" runat="server" CssClass="formNovo" 
                                            MaxLength="50" TabIndex="1" Width="300px"></asp:TextBox>
                                       <asp:RequiredFieldValidator Text="*" ErrorMessage="Favor informar o Norma." runat="server" ID="rfvNorma" ControlToValidate="txtNorma" CssClass="asterisco" ValidationGroup="cadastro"></asp:RequiredFieldValidator>
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtRevisao" runat="server" CssClass="formNovo" 
                                            MaxLength="50" TabIndex="1" Width="300px"></asp:TextBox>
                                    </td>
                                    </tr>
                    ...
                    <asp:HiddenField ID="hdfCodNorma" runat="server" />
                </table>
            </div>
...
<asp:HiddenField ID="hdfTargetIncluirNorma" runat="server" />    
