<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="CadastraBitola.aspx.cs" Inherits="Nissi.WebPresentation.MateriaPrima.CadastraBitola" %>
...
<table style="margin-left: auto; width: 95%; margin-right: auto;">
    <tr>
        ...
        <td class="titulo">Cadastro de Bitola</td>
    </tr>
</table>
<br />
...
<br />
<ajaxToolkit:ModalPopupExtender ID="mpeIncluirBitola" runat="server" PopupControlID="pnlIncluirBitola"
    TargetControlID="hdfTargetIncluirBitola" BehaviorID="mpeIncluirBitolaID" BackgroundCssClass="modalBackground"
    DropShadow="true" />    
<asp:Panel ID="pnlIncluirBitola" DefaultButton="btnSalvar" runat="server">
                    ...
                    <tr> 
                        <td>
                            <table cellpadding="3" cellspacing="0" class="fundoTabela" style="text-align:left">
                                ...
                                <tr>
                                    <td style="padding-left:20px">Bitola:</td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtBitola" runat="server" CssClass="formNovo" 
                                            MaxLength="50" TabIndex="1" Width="300px"></asp:TextBox>
                                       <asp:RequiredFieldValidator Text="*" ErrorMessage="Favor informar o Bitola." runat="server" ID="rfvBitola" ControlToValidate="txtBitola" CssClass="asterisco" ValidationGroup="cadastro"></asp:RequiredFieldValidator>
                                    </td>
                                    </tr>
