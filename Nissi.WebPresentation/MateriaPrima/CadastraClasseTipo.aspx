<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="CadastraClasseTipo.aspx.cs" Inherits="CadastraClasseTipo" %>
...
<table style="margin-left: auto; width: 95%; margin-right: auto;">
    <tr>
        ...
        <td class="titulo">Cadastro de ClasseTipo</td>
    </tr>
</table>
<br />
                        ...
                        <div id="divListaResultado" runat="server" style="overflow: auto; display: block; text-align:center; height:400px;">
                            <cc1:RDCGrid 
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="ClasseTipo" >
...
<br />
<ajaxToolkit:ModalPopupExtender ID="mpeIncluirClasseTipo" runat="server" PopupControlID="pnlIncluirClasseTipo"
    TargetControlID="hdfTargetIncluirClasseTipo" BehaviorID="mpeIncluirClasseTipoID" BackgroundCssClass="modalBackground"
    DropShadow="true" />    
<asp:Panel ID="pnlIncluirClasseTipo" runat="server">
        ...
        <ContentTemplate>
            <div style="text-align: center;width:900px; height:auto; padding: 5px 5px 5px 5px; background-color: #ffffff;">
                        ...
                        <td class="titulo">
                            <b>
                                <% if (hdfTipoAcao.Value == "Incluir") { %>
                                        ::Inclusão de ClasseTipo
                                <% } %>
                                <% else { %>
                                        ::Alteração de ClasseTipo
                                <% } %>
                            </b>
                        </td>
                    </tr>
                ...
                <table width="100%" align="center" class="fundoTabela" >
                    <tr> 
                        <td>
                            <table cellpadding="3" cellspacing="0" class="fundoTabela" style="text-align:left">
                                ...
                                <tr>
                                    <td style="padding-left:20px">Classe / Tipo:</td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtClasseTipo" runat="server" CssClass="formNovo" 
                                            MaxLength="50" TabIndex="1" Width="300px"></asp:TextBox>
                                       <asp:RequiredFieldValidator Text="*" ErrorMessage="Favor informar o ClasseTipo." runat="server" ID="rfvClasseTipo" ControlToValidate="txtClasseTipo" CssClass="asterisco" ValidationGroup="cadastro"></asp:RequiredFieldValidator>
                                    </td>
                                    </tr>
                    ...
                    <asp:HiddenField ID="hdfCodClasseTipo" runat="server" />
                </table>
            </div>
...
<asp:HiddenField ID="hdfTargetIncluirClasseTipo" runat="server" />    
