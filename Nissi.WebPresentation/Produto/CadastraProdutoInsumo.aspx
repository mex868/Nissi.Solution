<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" EnableEventValidation="false" AutoEventWireup="true"  CodeBehind="CadastraProdutoInsumo.aspx.cs" Inherits="CadastroProdutoInsumo" Title="Cadastro de Produto" %>
...
<table style="margin-left: auto; width: 95%; margin-right: auto;">
    <tr>
        ...
        <td class="titulo">Cadastro de Produto Insumo</td>
    </tr>
</table>
<br />
        ...
        <tr>
            ...
            <td colspan="2" style="height:36px">
                <div id="divCodigo"  style="display:block">
                    <asp:TextBox ID="txtCodigoPesq" onkeypress="KeyDownHandler();" MaxLength="18" runat="server" Height="16px" Width="150px"></asp:TextBox>
                ...
                <div id="divDescricao" style="display:none">
                    <asp:TextBox ID="txtDescricaoPesq" onkeypress="KeyDownHandler();" runat="server" Height="16px" Width="600px"></asp:TextBox>
                            ...
                            MinimumPrefixLength="1" ServiceMethod="GetProdutoInsumo" CompletionInterval="800" EnableCaching="true"
                            ...
                            <cc1:RDCGrid 
                                ...
                                <Columns>
                                   ...
                                   <asp:BoundField HeaderText="Unidade" >
                                    ...
                                    <asp:BoundField HeaderText="Preço de Compra">
                                    <HeaderStyle CssClass="headerGrid" />
                                    </asp:BoundField>
                                </Columns>
                            </cc1:RDCGrid>
                        ...
                        <td class="titulo">
                            <b>
                                <% if (hdfTipoAcao.Value == "Incluir") { %>
                                        ::Inclusão de Produto Insumo
                                <% } %>
                                <% else { %>
                                        ::Alteração de Produto Insumo
                                <% } %>
                            </b>
                        </td>
                    </tr>
                        ...
                        <td>
                            <table cellpadding="3" cellspacing="0" class="fundoTabela" style="text-align:left">
                                ...
                                <tr>
                                   ...
                                   <tr>
                                    <td style="padding-left:17px">Unidade de Medida:</td>
                                   ...
                                   <tr>
                                       <td>
                                        ...
                                        <img alt="" src="../Imagens/Incluir.png" onclick="ChamaPopup();" title="Incluir Unidade" style="width:18px; height:18px; cursor:hand"/>
                                            ...
                                            <td>
                                            <asp:TextBox ID="txtValor" runat="server" CssClass="formNovo" 
                                            MaxLength="50" TabIndex="1" Width="100px"/>
                                        </td>
                                      </tr>
                                      <tr>
