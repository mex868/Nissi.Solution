<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="CadastraDepartamento.aspx.cs" Inherits="CadastraDepartamento" %>
...
<table style="margin-left: auto; width: 95%; margin-right: auto;">
    <tr>
        ...
        <td class="titulo">Cadastro de Departamento</td>
    </tr>
</table>
<br />
...
<br />
<ajaxToolkit:ModalPopupExtender ID="mpeIncluirDepartamento" runat="server" PopupControlID="pnlIncluirDepartamento"
    TargetControlID="hdfTargetIncluirDepartamento" BehaviorID="mpeIncluirDepartamentoID" BackgroundCssClass="modalBackground"
    DropShadow="true" />    
<asp:Panel ID="pnlIncluirDepartamento" runat="server">
                    ...
                    <tr> 
                        <td>
                            <table cellpadding="3" cellspacing="0" class="fundoTabela" style="text-align:left">
                                ...
                                <tr>
                                    <td>
                                        <asp:TextBox ID="txtDepartamento" runat="server" CssClass="formNovo" 
                                            MaxLength="50" TabIndex="1" Width="300px"></asp:TextBox>
                                            <asp:RequiredFieldValidator Text="*" runat="server" ErrorMessage="Favor informar o departamento." ID="rfvDepartamento" ControlToValidate="txtDepartamento" CssClass="asterisco" ValidationGroup="cadastro"></asp:RequiredFieldValidator>
                                    </td>
                                    </tr>
                                    ...
                                    <table class="fundoTabela">
                                        <tr>
                                            ...
                                            <td style="text-align:right">
                                                <asp:Button ID="btnSalvar" ValidationGroup="cadastro" runat="server" CssClass="botao" 
                                                onclick="btnSalvar_Click" Text="Salvar" Width="80px" />
                                           </td>
                                        </tr>
                                    </table>
                                </ContentTemplate>
...
<asp:HiddenField ID="hdfTargetIncluirDepartamento" runat="server" />    
